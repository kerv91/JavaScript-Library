...
//challange using array.protype.filter() method, filter through the presidents array and console.log only the presidents who were born in the 1900s

const birthYear = presidents.filter(presidents => president.year >= 1900 &&president.year < 2000)
